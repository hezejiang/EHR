...
{
	/// <summary>
	/// record_FamilyBaseInfo
	/// </summary>
	public partial class record_FamilyBaseInfo
	{
		private readonly Irecord_FamilyBaseInfo dal=DataAccess.Createrecord_FamilyBaseInfo();
		...
		public Maticsoft.Model.record_FamilyBaseInfo GetModelByCache(int FamilyID)
		{
			...
			return (Maticsoft.Model.record_FamilyBaseInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.record_FamilyBaseInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.record_FamilyBaseInfo> DataTableToList(DataTable dt)
		{
			List<Maticsoft.Model.record_FamilyBaseInfo> modelList = new List<Maticsoft.Model.record_FamilyBaseInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.record_FamilyBaseInfo model;
