...
namespace Maticsoft.SQLServerDAL
{
	...
	/// 数据访问类:sys_Roles
	/// </summary>
	public partial class sys_Roles:Isys_Roles
	{
		public sys_Roles()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("RoleID", "sys_Roles"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select RoleID,R_UserID,R_RoleName,R_Description ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" RoleID,R_UserID,R_RoleName,R_Description ");
			strSql.Append(" FROM sys_Roles ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from sys_Roles T ");
