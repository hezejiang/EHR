...
{
	/// <summary>
	/// 接口层extend_Disability
	/// </summary>
	public interface Iextend_Disability
	{
		#region  成员方法
		/// <summary>
		/// 得到最大ID
		...
		/// 是否存在该记录
		/// </summary>
		bool Exists(int DisabilityID);
		/// <summary>
		/// 增加一条数据
		/// </summary>
		int Add(Maticsoft.Model.extend_Disability model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(Maticsoft.Model.extend_Disability model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		bool Delete(int DisabilityID);
		bool DeleteList(string DisabilityIDlist );
		/// <summary>
		/// 得到一个对象实体
		/// </summary>
