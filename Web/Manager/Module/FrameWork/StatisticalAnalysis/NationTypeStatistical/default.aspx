<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/PageTemplate.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="FrameWork.web.Module.FrameWork.StatisticalAnalysis.NationTypeStatistical._default"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="server">
    ...
    <FrameWorkWebControls:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadOPTxt="民族类型统计" HeadTitleTxt="民族类型统计">
