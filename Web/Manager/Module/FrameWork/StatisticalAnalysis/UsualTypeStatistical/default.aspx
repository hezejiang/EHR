<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/PageTemplate.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="FrameWork.web.Module.FrameWork.StatisticalAnalysis.UsualTypeStatistical._default"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="server">
    ...
    <FrameWorkWebControls:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadOPTxt="常住类型统计" HeadTitleTxt="常住类型统计">
