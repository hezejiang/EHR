<%@ Page Language="C#"MasterPageFile="~/Manager/MasterPage/PageTemplate.Master"  AutoEventWireup="true" CodeBehind="InfoManager.aspx.cs" Inherits="FrameWork.web.Module.FrameWork.HealthSupervision.Inspect.InspectManager" %>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
                <tr id="TopTr" runat="server">
                    <td class="table_body">
                        巡查时间</td>
                    <td class="table_none">
                        <asp:TextBox ID="I_Date" runat="server" Columns="50" title="请选择发现时间!" CssClass="text_input" onfocus="javascript:HS_setDate(this);"></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr id="Tr2" runat="server">
                    <td class="table_body">
                        巡查地点</td>
                    <td class="table_none">
                        <asp:TextBox ID="I_Location" runat="server" Columns="50" title="请输入巡查地点!" CssClass="text_input" ></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="table_body">
                        巡查内容</td>
                    <td class="table_none">
                        <asp:TextBox ID="I_Content" runat="server" Columns="50" title="请输入巡查内容!"
                ...
                <tr>
                    <td class="table_body">
                        发现主要问题</td>
                    <td class="table_none">
                        <asp:TextBox ID="I_MainProblem" runat="server" Columns="50" title="请输入主要问题!"
                            CssClass="text_input" TextMode="MultiLine" style="height:100px;"></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr id="tr_username" runat="server">
                    <td class="table_body" >
                       巡查人</td>
                    <td class="table_none">
                        <asp:TextBox ID="I_UserID_input" runat="server" Columns="50" title="请点击选择巡查人!"
                            CssClass="text_input" ReadOnly></asp:TextBox>
                        <input type="hidden" id="I_UserID" runat="server" />
                        <input type=button value="选择巡查人" name="buttonselect" onClick="javascript:ShowDepartID()" class="cbutton">
