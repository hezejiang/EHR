...
//miniui
document.write('<script src="' + bootPATH + 'jquery-1.7.1.min.js" type="text/javascript"></sc' + 'ript>');
document.write('<script src="' + bootPATH + 'miniui/miniui_v3.js" type="text/javascript" ></sc' + 'ript>');
