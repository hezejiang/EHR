...
namespace Maticsoft.Web.record_FimaryProblem
{
	...
	private void ShowInfo()
	{
		...
		this.txtF_RecordTime.Text=model.F_RecordTime.ToString();
		this.txtF_StartTime.Text=model.F_StartTime.ToString();
		this.txtF_endTime.Text=model.F_endTime.ToString();
		this.txtF_OverviewProblem.Text=model.F_OverviewProblem;
		this.txtF_DetailProblem.Text=model.F_DetailProblem;
