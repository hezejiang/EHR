<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeBehind="Add.aspx.cs" Inherits="Maticsoft.Web.sys_Module.Add" Title="增加页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtM_ApplicationID" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		所属父级模块ID与Module
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtM_PageCode" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		模块/栏目名称当ParentI
